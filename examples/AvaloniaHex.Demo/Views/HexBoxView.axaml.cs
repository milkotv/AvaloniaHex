...
namespace AvaloniaHex.Demo.Views
{
    public partial class HexBoxView : UserControl
    {
        public HexBoxView()
        {
            ...
            HexBox.HexView.GotFocus += HexViewOnGotFocus;
            HexBox.HexView.LostFocus += HexViewOnLostFocus;
        ...
        private void HexViewOnLostFocus(object? sender, RoutedEventArgs e)
        {
            _hasFocus = false;
            UpdateLabels();
        }
        private void HexViewOnGotFocus(object? sender, GotFocusEventArgs e)
        {
            _hasFocus = true;
            UpdateLabels();
        }
